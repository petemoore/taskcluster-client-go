...
// https://community-tc.services.mozilla.com/references/secrets/v1/api.json
...
// https://community-tc.services.mozilla.com/references/secrets/v1/api.json together with the input and output schemas it references, downloaded on
